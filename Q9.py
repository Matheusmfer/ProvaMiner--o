...
'j) Exporte seu dataframe para um arquivo com extensão XLSX'import pandas as pd
...
tita = titanic.groupby('Pclass', as_index = False)['Survived'].count()

plt.bar(tita['Pclass'], titaG['Survived'])
plt.show()
